...
def train(
    ...
    if dataset_name=='Waterloo':
        ...
        dataset = rain13k(root_dir=train_dir, noise_level=noise_level, crop_size=128, num_crops=2, normalize=True,augmentation=get_training_augmentation())
