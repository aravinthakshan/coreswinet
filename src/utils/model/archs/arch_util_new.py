...
class PixelUnshuffle1(nn.Module):
    ...
    def forward(self, input: Tensor) -> Tensor:
        ...
        assert hh % self.downscale_factor == 0 and hw % self.downscale_factor == 0
        h =torch.div(hh, self.downscale_factor, rounding_mode='floor')
        w =torch.div(hw, self.downscale_factor, rounding_mode='floor')
